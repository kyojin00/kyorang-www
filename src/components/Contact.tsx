...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    // TODO: 실제 메일 발송 연동 (EmailJS, Resend 등)
    setSent(true)
  }
      ...
      <div className="max-w-xl mx-auto">
        ...
        {sent ? (
          ...
          >
            ...
            <p className="font-medium" style={{ color: 'var(--deep-purple)' }}>
              메시지를 받았어요!
            </p>
          ...
          >
            <div className="flex flex-col gap-1">
              <label className="text-xs font-medium" style={{ color: 'var(--soft-brown)' }}>
                이름
              </label>
              <input
                type="text"
                ...
                style={{
                  ...
                  border: '1px solid rgba(124,107,181,0.2)',
                  color: 'var(--text-dark)',
                }}
              />
            </div>
            ...
            <button
              type="submit"
              className="py-4 rounded-xl font-medium text-white transition-opacity hover:opacity-80"
        ...
        <p className="text-center text-xs mt-6" style={{ color: 'var(--soft-brown)', opacity: 0.7 }}>
          또는{' '}
          <a href="mailto:hello@kyorang.com" style={{ color: 'var(--warm-purple)' }}>
            hello@kyorang.com
          </a>
          으로 직접 연락주세요
        </p>
