    ...
    <section id="mission" className="py-28 px-6" style={{ background: 'var(--peach)' }}>
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: 'Noto Serif KR', color: 'var(--deep-purple)', lineHeight: 1.4 }}>고민이 가벼워지는 세상</h2>
          <p className="text-lg max-w-2xl mx-auto leading-relaxed" style={{ color: 'var(--soft-brown)', fontWeight: 300 }}>
            무겁게 들고 다니던 고민을 누군가에게 털어놓는 것, 그 작은 행동이 삶을 바꾼다고 믿습니다. 교랑은 그 공간을 만드는 팀입니다.
          </p>
        </div>
